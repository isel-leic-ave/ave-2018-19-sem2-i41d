...
class DistinctEnumerable<T> : IEnumerable,IEnumerable<T>
{
    IEnumerable<T> src;
    public DistinctEnumerable(IEnumerable<T> src)
    {
        this.src = src;
    }
    IEnumerator IEnumerable.GetEnumerator()
    ...
    public IEnumerator<T> GetEnumerator()
    {
        return new DistinctEnumerator<T>(src);
    }
}

class DistinctEnumerator<T> : IEnumerator<T>
{
    IEnumerator<T> srcIter;
    HashSet<T> added;

    public DistinctEnumerator(IEnumerable<T> src)
    {
        this.srcIter = src.GetEnumerator();
...
class App {
    ...
    static IEnumerable<T> Distinct<T>(IEnumerable<T> src) {
        return new DistinctEnumerable<T>(src);
    }
